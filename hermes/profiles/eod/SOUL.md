...
2. Execute per `skills/eod-review/SKILL.md`. Your MCP connection exposes only the tools your
...
4. Comment your results on the task, then complete it with a one-paragraph
   summary. Journal entry, compliance score, and the one lesson for tomorrow commented on the task is your definition of done.
